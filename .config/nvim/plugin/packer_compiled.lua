...
_G.packer_plugins = {
  ...
  coq_nvim = {
    loaded = true,
    path = "/home/sami/.local/share/nvim/site/pack/packer/start/coq_nvim",
  ...
  nerdcommenter = {
    loaded = true,
    path = "/home/sami/.local/share/nvim/site/pack/packer/start/nerdcommenter",
    url = "https://github.com/scrooloose/nerdcommenter"
  },
  nerdtree = {
    loaded = true,
    path = "/home/sami/.local/share/nvim/site/pack/packer/start/nerdtree",
  ...
  ["nvim-lspinstall"] = {
    loaded = true,
    path = "/home/sami/.local/share/nvim/site/pack/packer/start/nvim-lspinstall",
  ...
  ["vim-peekaboo"] = {
    loaded = true,
    path = "/home/sami/.local/share/nvim/site/pack/packer/start/vim-peekaboo",
